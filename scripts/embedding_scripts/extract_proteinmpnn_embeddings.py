...
Usage:
                            conda activate petase_structure_activity
                        python start_here/embedding_scripts/extract_proteinmpnn_embeddings.py \
...
PROTEINMPNN_PATH = "/Users/andrewlee/Documents/GitHub/ProteinMPNN"
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="proteinmpnn",
        help="Tag included in output filenames (e.g. seo_11_proteinmpnn.npz)",
    )
